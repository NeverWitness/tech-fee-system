...
本项目目录名和文件名中的“制度”“演化”等表述，仅用于结构搭建，不代表具体意图、设计或路径。  
文档中的制度相关内容：

**应理解为基于该分析框架的推导与探索，不是预设制度方案，而是基于该分析框架的延伸讨论。**
...
本项目属于 **结构分析为核心、相关问题讨论为延伸** 的研究，而非具体政策方案。

其中：

- 结构分析：是本项目的核心内容
- 相关问题讨论：是在该结构基础上的延伸分析
...
- [结构变化的可能表现](evolution/institutional-evolution.md)
...
- 去除路径与制度预设表述，统一为结构性分析框架
- 调整结构表达，使分析与延伸讨论层级更加清晰
